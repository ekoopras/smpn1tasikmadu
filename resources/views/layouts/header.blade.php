      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-4 gap-3"> 
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item fw-light" href="{{ route('blog.show', 'selayang-pandang') }}">Selayang Pandang</a></li>
            <li><a class="dropdown-item fw-light" href="{{ route('blog.show', 'profil-kepala-sekolah') }}">Profil Kepala Sekolah</a></li>
...
.navbar-nav .nav-link {
    font-size: 15px;   /* default Bootstrap 16px → dikecilkan */
    padding-top: 4px;
    padding-bottom: 4px;
    color: #666666;
}
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="mobileMenu">
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="collapse ps-4" id="profilMenu">
      <li><a class="nav-link" href="{{ route('blog.show', 'selayang-pandang') }}">• Selayang Pandang</a></li>
      <li><a class="nav-link" href="{{ route('blog.show', 'profil-kepala-sekolah') }}">• Profil Kepala Sekolah</a></li>
